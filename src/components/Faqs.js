...
import ios1 from "../images/iOS_TuneGevity.png";
import ios2 from "../images/iOS_TuneGevity_2.png";
    ...
    <section id="faq" className="section top">
      ...
      >
        ...
        >
          ...
          <div className="p-answers">
            <p>
              ...
              digital marketplace that sold it.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="p-answers">
            <p>
              VASTR uses proprietary technology to protect licensed music from
              piracy and unauthorized use. The platform enables asset holders to
              control access to their music, enforce copyright protections, and
              take immediate action against violators, such as banning users
              found to be uploading or using unlicensed content.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="p-answers">
            <p>
              VASTR is iOS and Android compatible, while being open to digital
              music aggregators. With Deamle—our consumer app—you can create
              gated access to exclusive content. This allows you to offer
              special artist experiences while controlling how music is
              distributed and priced. From pre-releases to exclusive tracks,
              you’re in full control of getting your clients’ music into the
              hands of their fanbase.
            </p>
            <div className="card-rows">
              <img
                ...
                loading="lazy"
                sizes="100vw"
                //srcset="../images/iOS_TuneGevity-p-500.png 500w, ../images/iOS_TuneGevity-p-800.png 800w, ../images/iOS_TuneGevity-p-1080.png 1080w, ../images/iOS_TuneGevity.png 1432w"
                alt=""
                className="image"
              />
              <img
                ...
                loading="lazy"
                sizes="100vw"
                //srcset="../images/iOS_TuneGevity_2-p-500.png 500w, ../images/iOS_TuneGevity_2-p-800.png 800w, ../images/iOS_TuneGevity_2-p-1080.png 1080w, ../images/iOS_TuneGevity_2.png 1432w"
                alt=""
                className="image"
              />
            </div>
        ...
        >
          <div className="space-between row">
            ...
            />
            <div className="spacer10"></div>
            <p>How does this work with VASTR? </p>
          </div>
          <div className="spacer20"></div>
          <div className="p-answers">
            <p>
              ...
              and distributed to approved applications like Deamle. Consumers
              may log into any approved app and fund their accounts. Account
              balances are available to consumers in all of the approved apps,
              i.e. funding in one app still provides tokens in the other.{" "}
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="p-answers">
            <p>
              Digital stores receive their share at the time of sale for a
              license (when a consumer listens).{" "}
            </p>
          </div>
        </div>
      </div>
